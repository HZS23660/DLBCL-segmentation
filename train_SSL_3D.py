...
parser.add_argument('--root_trainpath', type=str,
                    default='/media/tju/0001-B5DA/PET_lymphoma/PET_lymphoma_TrainData_prior_120_128 64 64', help='Name of Experiment')
parser.add_argument('--root_valpath', type=str,
                    default='/media/tju/0001-B5DA/PET_lymphoma/PET_lymphoma_ValData_prior', help='Name of Experiment')
parser.add_argument('--root_modelpath', type=str,
                    default='D:/HZS/SSL4MIS_huang/Code/model/PET_lymphome_3D/PWS_120_labeled_224 96 96/vnet_att/vnet_att_best_model.pth', help='Name of Experiment')
parser.add_argument('--exp', type=str,
                    default='PET_lymphoma_3D/SS_l0.5_a0.2', help='experiment_name')
...
def train(args, snapshot_path):
    ...
    # ce_cos_loss = losses.CE_Cosine_Similarity_Loss(args.num_classes)
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            all_consistency_loss = supervised_loss2 + consistency_loss
            ...
            logging.info(
                'iteration %d : loss : %f, loss_ce: %f, loss_dice: %f, loss_cos: %f' %
